...
public class FilmMapper {
	...
	public static FilmDTO convertFilmToFilmDTO(Film film) {
		...
		filmDTO.setRealisateur(convertRealisateurToRealisateurDTO(film.getRealisateur()));
	...
	public static Film convertFilmDTOToFilm(FilmDTO filmDTO) {
		...
		film.setRealisateur(convertRealisateurDTOToRealisateur(filmDTO.getRealisateur()));
