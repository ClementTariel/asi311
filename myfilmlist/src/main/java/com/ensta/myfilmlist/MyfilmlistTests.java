...
public class MyfilmlistTests {
	...
	/**
	 * Permet de tester le filtrage des realisateurs en fonction de leur celebrite
	 */
	public void updateRealisateurCelebresTest() {
		...
		try {
			...
			// Attendue : Peter Jackson
			System.out.println("Realisateurs celebres ? ");
			for (Realisateur r:realisateursCelebres) {
